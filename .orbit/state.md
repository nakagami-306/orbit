<!-- orbit:generated | 2026-04-17T22:29:31Z | branch:main | head:019d9d90-478e-71bd-906f-30200955138c -->
# orbit
...
CLI関数に対応するClaude Code Pluginを実装。plugin/ディレクトリに配置。skillsはCLIコマンドの薄いラッパーではなく、ワークフロー単位で複数コマンドを組み合わせた設計。
...
| (hooks.json inline) | Stop | prompt-based | LLMが直前の応答を確認し「設計議論があったか？記録されたか？」を判断。未記録ならblockして記録を強制。コード実装中はapprove |
