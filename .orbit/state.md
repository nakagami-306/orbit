<!-- orbit:generated | 2026-04-26T06:05:33Z | branch:main | head:019dc864-a7eb-7a59-be6f-82177201f19b -->
# orbit
...
Plugin v2 は2026-04にPhase 1（SessionStart刷新・DecideGuard強化・AI連携Section再構成）とPhase 2（Stop hook再導入・thread add type推論・decide/edit CLIでのTask提案）の両方を完了し v0.4.1 として配信中。
