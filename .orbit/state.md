<!-- orbit:generated | 2026-04-17T00:07:37Z | branch:main | head:019d98c3-bb6d-7339-9dc9-754c78eeb142 -->
# orbit
...
### Decision
- 全Decisionは必ずいずれかのSectionを更新する（強制）。Section内容は累積ではなくスナップショット（上書き）。大小問わず決定事項はすべてStateに反映する。履歴はDecision DAGが担う
